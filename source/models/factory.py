from .model_pomm import PommNetNoRNN
from .model_pomm import PommNet
from .model_generic import CNNBase, MLPBase
from .policy import PolicyNoRNN
from .policy import Policy

def old_create_policy(obs_space, action_space, name='basic', nn_kwargs={}, train=True):
    nn = None
...
def create_policy(obs_space, action_space, name='basic', nn_kwargs={}, train=True):
    ...
    policy = PolicyNoRNN(nn, action_space=action_space)
